...
let sourceBuffer;
let bufferQueue = []; // Warteschlange für Chunks
// Default source
...
(_a = document.querySelector("#play")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", (event) => {
    var _a;
    event.preventDefault();
    const fileInput = document.querySelector("#file");
    const file = (_a = fileInput === null || fileInput === void 0 ? void 0 : fileInput.files) === null || _a === void 0 ? void 0 : _a.item(0);
    if (!file) {
